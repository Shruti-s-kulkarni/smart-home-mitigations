...
| :---                      | :---:                 |  :---:                                           |
|                           |                       |                                                  |
| Compromise via vulnerabilities in applications downloaded from public repositories | Least privilege | Close unwanted ports on the router such as 21, 22, 25 |
|                           |
